...
public class TexTemplateCompletion extends TemplateCompletionProcessor {
	 ...
	 * <code>contextTypeId</code>. This implementation always returns the shared
	 * TexTemplateStore.
	 * 
	 ...
	 * region in the viewer's document. This implementation always returns the
	 * TEX_CONTEXT_TYPE.
	 * 
	 * @see TexContextType
	 * @param viewer
	...
	/**
	 * Adds all available TeX templates to the given list, available meaning
	 * here that the templates match the found prefix.
	 * 
	 * @param viewer
	...
	/**
	 * This method overrides the default one (which is suited for Java (i.e.
	 * result in NOT replacing anything before '.', which causes inconvenience,
	 * when templates are named like "list.itemize"
	 * 
	 * @param viewer
	 * @param offset
	 *            Document offset
