...
public final class AStrbraceStringEntry extends PStringEntry {
	...
	public AStrbraceStringEntry( TIdentifier _identifier_,
	...
	@Override
	public Object clone() {
		return new AStrbraceStringEntry(cloneNode(this._identifier_), cloneNode(this._stringLiteral_));
	}
	...
	public String toString() {
		return "" + toString(this._identifier_) + toString(this._stringLiteral_);
	}
