...
public class PathUtils {
	...
	/**
	 * Merge the given environment variables to the additional environment
	 * variables that are defined in the preferences. The variables defined in
	 * the preferences override the variables given as a parameter.
	 * 
	 * @param env
	 *            current environment variables
	 * @param prefName
	 *            preference name where to read additional environment variable
	 *            map
	 * @return merged environment variables as a suitable array for the
	 *         Process.exec() -method
	 */
	...
	/**
	 * Replaces environment variable names with their values in the given
	 * string.
	 * 
	 * @param envProp
	 *            environment variables
	 * @param str
	 *            value for a new environment variable
	...
	/**
	 * Load a Map from preferences. The map is encoded into a String object by
	 * separating keys from values with a '=' and key/value-pairs with a ','.
	 ...
	 * 
	 * @param prop
	 *            key/value -mappings as properties
	...
	/**
	 * Splits the given string into tokens so that sections of the string that
	 * are enclosed into quotes will form one token (without the quotes).
	 * 
	 * E.g. string = "-editor \"echo %f:%l\" -q" tokens = { "-editor",
	 * "echo %f:%l", "-q" }
	 * 
	 * @param args
	 *            the string
	 * @param list
	 *            tokens will be added to the end of this list in the order they
	 *            are extracted
	 */
	 ...
	 * 
	 * @param bin
	 *            relative path and file name to search for in the directories
	 *            listed in the "path" environment variable
	 * @return the directory that contains the given file or null if file was
	 *         not found
	 */
	 ...
	 *            file to search for
	 * @param path
	 *            default path to use if the environment variable "path" doesn't
	 *            contain the searched file
	 * @param winFile
	 *            file to search for in windows
	 * @param winPath
	 ...
	 * @return operating system environment variables and their values in a
	 *         properties object or empty properties object if an error occurs
	 */
	...
	/**
	 * Finds the property that represents the "path" environment variable. This
	 * has to be done as a search, because environment variables are case
	 * insensitive in Windows and property keys are case sensitive.
	 * 
	 * @param prop
