...
/**
 * BibTeX string rule for "..." -style strings. Takes into account that { and }
 * must be matched inside a string.
 * 
 * @author Oskar Ojala
 */
public class BibStringRule implements IPredicateRule {
	 ...
	 * 
	 * @param token
	 *            The token to return on a successful match
	 */
	 ...
	 *            The scanner
	 * @param numChars
	 *            The number of characters to unread
	 */
