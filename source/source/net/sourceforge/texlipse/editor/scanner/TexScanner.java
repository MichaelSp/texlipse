...
/**
 * TexScanner is used as a default scanner at the moment. It works for
 * "__tex_default" content type areas. It uses defined rules to detect sequences
 * and it returns the specified token that satisfies a rule. The token defines
