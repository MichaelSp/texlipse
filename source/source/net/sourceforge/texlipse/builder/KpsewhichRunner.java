 ...
 * implementing a JNI interface, if more clumsy). The ProgramRunner interface
 * isn't a perfect match because kpathsea doesn't have input and output
 * filetypes etc, but this lets us integrate with other parts of TeXlipse with
 * minimal effort.
 * 
...
public class KpsewhichRunner implements ProgramRunner {
	 ...
	 * @param resource
	 *            The path to run the command in
	 * @return Output from the command
	 * @throws CoreException
	 *             Thrown if running the external command generates an exception
	 */
	 ...
	 * 
	 * @param resource
	 *            folder to run kpsewhich in
	 * @param filename
	 *            Name of the file to find
	 * @param progname
	 *            Name of the calling program (path searched may depend on this)
	 ...
	 * 
	 * @param resource
	 *            Directory to run kpsewhich in
	 * @param ext
	 *            The extension to search for
	 * @return An array of Kpath objects, representing the search paths.
	 * @throws CoreException
	 *             Thrown if running kpsewhich throws an exception
	 */
