...
/**
 * Manages the abbreviations in a BibTeX file, used to do content assist on
 * abbreviation names.
 * 
 * @author Oskar Ojala
 */
public class AbbrevManager extends PartialRetriever {
	 ...
	 * 
	 * @param start
	 *            The beginning of an abbrev
	 * 
	 * @return References entries of abbrev, whose beginning matched the start
	 */
