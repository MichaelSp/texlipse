...
/**
 * Builder configuration dialog. Configures all the different ProgramRunner
 * classes.
 * 
...
public class BuilderConfigDialog extends Dialog {
	 ...
	 * @param path
	 *            file path
	 * @return true, if path is empty string or absolute path to an existing
	 *         file
	 */
	...
	protected Control createDialogArea(Composite parent) {
		...
		descrLabel.setText(TexlipsePlugin.getResourceString("preferenceBuilderDialogDescriptionLabel").replaceAll("%s",
