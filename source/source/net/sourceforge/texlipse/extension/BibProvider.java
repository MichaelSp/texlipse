...
public interface BibProvider {
	...
	/**
	 * This method allows optional plugins to control the entries that show up
	 * in the \cite autocomplete pop-up
	 * 
	 * @param offset
	 ...
	 * @param bibContainer
	 *            The {@link ReferenceContainer} with all the currently
	 *            available completions
	 * 
	 * @return The List with the favored CompletionProposals
	 */
	public List<ICompletionProposal> getCompletions(int offset, int replacementLength, String prefix,
			ReferenceContainer bibContainer);
