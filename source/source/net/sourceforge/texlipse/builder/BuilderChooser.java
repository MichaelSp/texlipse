...
/**
 * An UI component for choosing the builder. Consists of two Combo components
 * and a Label.
 * 
...
public class BuilderChooser {
	...
	public BuilderChooser(Composite parent) {
		...
		formatChooser.setItems(new String[] { TexlipseProperties.OUTPUT_FORMAT_DVI,
				TexlipseProperties.OUTPUT_FORMAT_PS, TexlipseProperties.OUTPUT_FORMAT_PDF });
		...
		prefLink.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				PreferencesUtil.createPreferenceDialogOn(
						formatGroup.getShell(),
						"TexlipseBuilderPreferencePage",
						new String[] { "TexlipseBuilderPreferencePage",
								"net.sourceforge.texlipse.properties.BuilderEnvPreferencePage" }, null).open();
			}
		});
	}
