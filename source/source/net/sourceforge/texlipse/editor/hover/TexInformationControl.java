...
public class TexInformationControl implements IInformationControl, IInformationControlExtension {
	...
	private final ReferenceManager refMana;
	private Image image;
	...
	/**
	 * Retrieves the argument from the given string containing a full TeX
	 * command
	 * 
	 * @param text
	 *            The TeX command
	...
	/**
	 * Retrieves the command from the given string containing a full TeX command
	 * 
	 * @param text
	 *            The TeX command in the form <code>command{arg}</code>
	 ...
	 * 
	 * @param labelName
	 *            The name of the label that's referred to
	 ...
	 * 
	 * @see
	 * org.eclipse.jface.text.IInformationControl#setInformation(java.lang.String
	 * )
	 */
