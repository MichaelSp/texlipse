...
public class ViewerListFieldEditor extends ListEditor {
	 ...
	 * 
	 * @param items
	 *            the items from the list component
	...
	/**
	 * Open the config editor dialog for editing an existing configuration. This
	 * is called, when edit button is pressed.
	 */
	...
	/**
	 * Insert a button to the button box. This method calls super and creates a
	 * the "edit"-button to the list.
	 */
	...
	/**
	 * Add an additional SelectionListener to the list component. This method
	 * call super and installs a SelectionListener, which enables and disables
	 * the "edit"-button.
	 */
	...
	/**
	 * Creates and returns a new item for the list. This implementation opens a
	 * question dialog, where user can enter a new item.
	 * 
	 * @return the string the user wanted to add, or null if the cancel button
	 *         was pressed or the string was an empty one
	 */
