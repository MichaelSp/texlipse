...
/**
 * Container class for outline input stuff. Includes the outline tree root list
 * and lists of nodes of each OutlineNode type. In addition contains the depth
 * of the outline tree.
 * 
...
public class TexOutlineInput {
	 ...
	 * @return The list containing the nodes of given type, null if no nodes of
	 *         that type exist.
	 */
