...
public class OutlineNode {
	 ...
	 *            type of the node
	 * @param beginLine
	 *            beginLine of the text of the node
	 * @param parent
	 ...
	 *            beginLine of the text of the node
	 * @param offset
	 *            The offset on the starting line
	 * @param length
	 *            The length of the command starting this node
	 */
	 ...
	 * 
	 * @param file
	 *            the file reference this node belongs to.
	 */
	...
	public String toString() {
		if (this.position == null) {
			return this.type + " " + this.name + " (null position) " + super.toString();
		} else {
			return this.type + " " + this.name + " " + this.position.getOffset() + " " + this.position.getLength()
					+ super.toString();
		}
	}

	/**
	 * Returns one type smaller (=more important) than the given type.
	 * 
	 * @param type
	 *            The current type
	...
	/**
	 * Updates the node with data from the node n. Assumes that name and type
	 * are equal
	 * 
	 * @param n
	...
	public boolean update(OutlineNode n) {
		if (n.beginLine != beginLine || n.endLine != endLine || n.offsetOnLine != offsetOnLine
				|| n.declarationLength != declarationLength || (n.position == null && position != null)
				|| (position == null && n.position != null)
	...
	/*
	 * public boolean likelySame(OutlineNode on) { if (on.getType() !=
	 * this.getType() || !this.getName().equals(on.getName())) { return false; }
	 * //pos -> see if the iterator preserves order
	 * 
	 * // make approximation
	 * 
	 * if (!this.getPosition().equals(on.getPosition())) { return false; }
	 * 
	 * return true; }
	 */
}
