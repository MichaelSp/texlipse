...
public class SelectedResourceManager implements IWindowListener, ISelectionListener {
	 ...
	 * or <code>null</code> if none. If an editor is active, the resource
	 * adapater associated with the editor is returned.
	 * 
	...
	/**
	 * Returns the current text selection as a <code>String</code>, or
	 * <code>null</code> if none.
	 * 
	 * @return the current text selection as a <code>String</code> or
	 *         <code>null</code>
	 */
