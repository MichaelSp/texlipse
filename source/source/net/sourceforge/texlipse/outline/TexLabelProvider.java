...
/**
 * Label provider for the OutlineNodes. The getName() method of the OutlineNodes
 * is used to get the label for a node.
 * 
 * All the for nodes of type ENVIRONMENT the name is used to find the right
 * image.
 * 
...
public class TexLabelProvider extends LabelProvider {
	...
	/**
	 * Returns the text description of the element. That is element name for
	 * OutlineNode.
	 * 
