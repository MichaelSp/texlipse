...
/**
 * A client program that connects to a server and writes the given filename and
 * line number to the given port.
 * 
 * @author Esa Seuranen
...
public class FileLocationClient {
	 ...
	 * 
	 * @param h
	 *            host name to connect to. Can be null to mean localhost.
	 * @param p
	 *            port number to connect to. Can be -1 to mean default port.
	 * @param f
	 *            file name that contains the line to show. Can't be null.
	 * @param l
	 *            line number to show. Has to be positive.
	 */
	...
	/**
	 * Write the filename and line number to the server socket. Format:
	 * "fileName:lineNumber".
	 */
	...
	/**
	 * Command line arguments: -p port (default: 55555) -h host (default:
	 * localhost) -f filename -l line number
	 */
