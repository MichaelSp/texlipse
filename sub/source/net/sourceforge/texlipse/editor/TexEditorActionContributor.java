...
public class TexEditorActionContributor extends TextEditorActionContributor {
	...
	TexInsertMathSymbolAction[] greekSmall;
	TexInsertMathSymbolAction[] greekCapital;
	TexInsertMathSymbolAction[] arrows;
	TexInsertMathSymbolAction[] stdCompare;
	TexInsertMathSymbolAction[] stdBinOp;
	...
	private void createMathActions(TexInsertMathSymbolAction[] actions, TexCommandEntry[] commands){
		for (int i=0; i<commands.length; i++){
			...
			actions[i].setImageDescriptor(commands[i].image);
		}
