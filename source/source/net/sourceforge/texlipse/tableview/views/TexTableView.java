...
public class TexTableView extends ViewPart {
	...
	// data of the table
	private final TexRowList rowList = new TexRowList();
	...
	/**
	 * The label provider class is responsible for providing the lables for the
	 * objects
	 */
	...
	public Table createTable(Composite parent) {
		int style = SWT.SINGLE | SWT.BORDER | SWT.H_SCROLL | SWT.V_SCROLL | SWT.HIDE_SELECTION | SWT.FULL_SELECTION;
		...
		// The way to add listener to column, so that rows are sorted when
		// header is clicked
		/*
