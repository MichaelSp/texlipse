...
public class LatexTempExtsPreferencePage extends FieldEditorPreferencePage implements IWorkbenchPreferencePage {
	...
	protected void createFieldEditors() {
		addField(new StringListFieldEditor(TexlipseProperties.TEMP_FILE_EXTS,
				TexlipsePlugin.getResourceString("preferenceTempFileExtsLabel"), getFieldEditorParent()));
		addField(new StringListFieldEditor(TexlipseProperties.DERIVED_FILES,
				TexlipsePlugin.getResourceString("preferenceDerivedFilesLabel"), getFieldEditorParent()));
	}
