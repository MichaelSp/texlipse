 ...
 * content type areas. It uses defined rules to detect sequences and it returns
 * the specified token that satisfies a rule. The token defines how the
...
public class TexOptArgScanner extends RuleBasedScanner {
	...
	public TexOptArgScanner(ColorManager manager) {
		...
		IToken commandToken = new Token(new TextAttribute(manager.getColor(ColorManager.SQUARE_BRACKETS), null,
