...
/**
 * Filter for the TeX document outline. Controls which type of OutlineNodes and
 * which ones of the type ENVIRONMENT are visible in the tree.
 * 
 * Internally contains two HashMaps, one for visible OutlineNode types and one
 * for visible environment names.
 * 
...
public class TexOutlineFilter extends ViewerFilter {
	...
	private HashSet<String> visibleEnvironments;

	public TexOutlineFilter() {
		super();
		visibleTypes = new HashSet<Integer>();
		visibleEnvironments = new HashSet<String>();
	}
	 ...
	 * @param visible
	 *            True if type should be visible, false if hidden
	 */
	 ...
	 *            (name)
	 * @param visible
	 *            True if the environment should be visible, false otherwise
	 */
