...
public class TexOutlineTreeView extends ViewPart implements ISelectionChangedListener, IPartListener {
	...
	public void createPartControl(Composite parent) {
		...
		// add a part listener if the editor isn't available when the view is
		// created.
	...
	/**
	 * Focuses the editor to the text of the selected item. Opens a new editor
	 * if the node is from a different file.
	 * 
	 * @param event
	 *            the selection event
	 */
