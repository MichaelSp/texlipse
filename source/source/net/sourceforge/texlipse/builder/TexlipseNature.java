...
public class TexlipseNature implements IProjectNature {
	...
	/**
	 * Configure the nature. Called by IProject.setDescription().
	 */
	...
	/**
	 * Deconfigure the nature. Called by IProject.setDescription().
	 */
	...
	/**
	 * Set the associated project. Called by IProject.setDescription().
	 */
	 ...
	 * 
	 * @param commands
	 *            list of commands containing the builders
	 * @param id
	 *            id of the builder to search for
