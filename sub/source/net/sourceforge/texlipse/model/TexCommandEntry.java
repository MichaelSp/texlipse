...
public class TexCommandEntry extends AbstractEntry {
	...
	/**
	 * Type of parameter (mandatory, optional or in braces)
	 */
	...
	/**
	 * Image of the command (usefull for math)
	 */
	...
	public TexCommandEntry(String _key, String _info, int _arguments) {
		...
		for (int i=0; i<_arguments; i++) para[i] = MAND_PARAMETER;
	}
	...
	public TexCommandEntry(String _key, String _info, String _imageName){
		...
		this.image = TexlipsePlugin.getImageDescriptor(_imageName);
	}
    ...
    public int compareTo(Object ae) {
    	...
    	if (c != 0) return c;
    	else return key.compareTo(((AbstractEntry) ae).key);
    }
