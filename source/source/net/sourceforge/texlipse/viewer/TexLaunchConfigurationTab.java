...
public class TexLaunchConfigurationTab extends AbstractLaunchConfigurationTab {
	...
	/**
	 * Creates the top level control for this launch configuration tab under the
	 ...
	 * 'viewerCurrent', the tab is initialized with the default values for the
	 * given viewer. The given viewer is expected to exist.
	 * 
	 * @param configuration
