...
/**
 * A superclass for the different types of entries that can occur in LaTeX file,
 * eg. command definitions or reference declarations.
 * 
 * This is essentially handled somewhat like a struct in C, due to efficiency
 * resons.
 * 
 * @author Oskar Ojala
 */
public abstract class AbstractEntry implements Comparable<AbstractEntry> {
	...
	/**
	 * The document position of the reference declaration (used for BibTeX
	 * editing)
	 */
	 ...
	 */
	public int compareTo(AbstractEntry ae) {
		return key.compareTo(ae.key);
	}
	 ...
	 * 
	 * @param docOffset
	 *            Offset from the document start
	 * @param length
