...
public abstract class TexlipseWizardPage extends WizardPage {
	 ...
	 * 
	 * The statusbar message is an error message, if at least one of the fields
	 * has an invalid value. If the current field has an invalid value, the
	 * corresponding error message is displayed. Otherwise, the first error
	 * message found (starting from the top) is displayed.
	 * 
	 * @param lastStatus
	 * @param number
	 */
