...
public class BibLabelProvider extends LabelProvider {
	 ...
	 * 
	 * @return returns an Image corresponding to the format if there is a file
	 *         available for this Bibtex entry.
	 */
	...
	/**
	 * Returns the text description of the element. That is the key element for
	 * a ReferenceEntry, or the string it self for a string.
	 * 
