...
public class TexEnvironmentRule implements IPredicateRule {
	 ...
	 * @param star
	 *            if true, this environment also detects the stared version of
	 *            the environment
	 * @param token
	 */
	...
	protected IToken doEvaluate(ICharacterScanner scanner, boolean resume) {
		...
		if (resume) {
			...
			// This works very good in Eclipse 3.2 - 3.3 but maybe not in other
			// versions.
	 ...
	 * 
	 * @param scanner
	 *            the charakter scanner
	 * @param readChar
	 *            the number of charakters to unread
	 * @return false
	 */
