...
/**
 * TexMathScanner is used for "__tex_mathParitition" -content type. It uses
 * defined rules to detect sequences and it returns the specified token that
 * satisfies a rule. The token defines how the characters are presented.
 * 
...
public class TexMathScanner extends RuleBasedScanner {
	...
	public TexMathScanner(ColorManager manager) {
		...
		IToken commandToken = new Token(new TextAttribute(manager.getColor(ColorManager.EQUATION), null,
