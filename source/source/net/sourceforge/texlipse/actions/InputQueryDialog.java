...
/**
 * A simple dialog window with "ok" and "cancel" -buttons, a label and a text
 * field.
 * 
 * This is almost like org.eclipse.jface.dialogs.InputDialog, but this version
 * has an image and creation-time-settable button texts.
 * 
...
public class InputQueryDialog extends MessageDialog {
	...
	/**
	 * Same kind of constructor as in InputDialog. This class just doesn't
	...
	public InputQueryDialog(Shell shell, String title, String message, String def, IInputValidator vali) {
		super(shell, title, null, message, QUESTION, new String[] { IDialogConstants.OK_LABEL,
	...
	/**
	 * Returns the text of the text field. Recommended to call after the dialog
	 * has been closed.
	 * 
	 * @return the text from the text field, or null if the user hasn't typed
	 *         anything yet
	 */
	...
	public static InputQueryDialog createQuery(String title, String message, String okText, String cancelText) {
		return new InputQueryDialog(new Shell(), title, null, // accept the
																// default
																// window icon
				message, QUESTION, new String[] { okText, cancelText }, 0); // OK
																			// is
																			// the
																			// default
	}
	...
	/**
	 * Convenience method to open a simple "enter text" dialog. This version
	 * uses the workbench default "ok" and "cancel" labels as button texts.
	 * 
	 * @param title
	 *            dialog title
	 * @param message
