...
/**
 * BibTeX partition scanner. Divides the BibTeX -document into two types of
 * partitions: one for inside the entries and one outside.
 * 
 * @author Oskar Ojala
 */
public class BibPartitionScanner extends RuleBasedPartitionScanner {
	...
	public BibPartitionScanner() {
		...
		List<BibBraceRule> rules = new ArrayList<BibBraceRule>();
