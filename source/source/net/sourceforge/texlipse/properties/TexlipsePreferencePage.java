...
public class TexlipsePreferencePage extends FieldEditorPreferencePage implements IWorkbenchPreferencePage {
	 ...
	 * 
	 * @param span
	 *            number of horizontal columns to span
	 * @param parent
	 *            parent container
	 */
	...
	/**
	 * Add a horizontal line to the page. This is equivalent to calling:
	...
	/**
	 * Add some empty horizontal space to the page. This is equivalent to
	 * calling: addSpacer(span, false, parent);
	 * 
	 * @param span
	 *            number of horizontal columns to span
	 * @param parent
	...
	/**
	 * Add some empty horizontal space to the page. This is equivalent to
	 * calling: addSpacer(2, false, parent);
	 * 
	 * @param parent
	 *            parent component
	 */
	...
	public static void addLabelField(int span, String str, Composite parent) {
		//
		// Bugfix for wrapping issue in Eclipse 3.0.1 for Windows (actually SWT
		// library):
		// if FieldEditorPreferencePage contains a plain Label, that has too
		// long
		// text, the wrapping doesn't get enabled, and other labels in the page
		// are also
		// not wrapped,
