...
/**
 * A rule for matching balanced curly-brace strings. (eg. {foob{bar}})
 * 
 * @author Oskar Ojala
 */
public class BibBraceRule implements IPredicateRule {
	...
	/**
	 * Creates a rule which will return the specified token when either an entry
	 * or a brace string is detected
	 * 
	 * @param e
	 *            Whether to detect an entry (true) or just a string (false)
	 * @param token
