...
/**
 * Objects of this class determines the hover region and returns the text of the
 * hover.
 * 
	...
	public IRegion getHoverRegion(ITextViewer textViewer, int offset) {
		try {
			...
			if (command.indexOf("cite") >= 0 && start > r.getOffset() + r.getLength()) {
				...
				int regionStart = line.lastIndexOf(',', start) < line.lastIndexOf('{', start) ? line.lastIndexOf('{',
						start) + 1 : line.lastIndexOf(',', start) + 1;
