...
public class BibCodeScanner extends RuleBasedScanner {
	 ...
	 * 
	 * @param provider
	 *            The color provider for syntax highlighting
	 */
	public BibCodeScanner(BibColorProvider provider) {
		...
		IToken comment = new Token(new TextAttribute(provider.getColor(BibColorProvider.SINGLE_LINE_COMMENT)));
		IToken other = new Token(new TextAttribute(provider.getColor(BibColorProvider.DEFAULT)));
