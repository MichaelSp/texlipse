...
public class BibContentProvider implements ITreeContentProvider {
	...
	private HashMap<String, BibOutlineContainer> contentIndex = new HashMap<String, BibOutlineContainer>();
	 ...
	 * 
	 * @param document
	 *            The document associated with this editor view
	 */
	 ...
	 * 
	 * @param sBy
	 *            sBy specifies the field by which the outline should be ordered
	 */
	public BibOutlineContainer changeSort(String sBy) {
		...
		if (contentIndex.containsKey(sBy)) {
			...
			if (BibOutlineContainer.SORTYEAR.equals(sBy)) {
				newContainer = ((BibOutlineContainer) contentIndex.get(BibOutlineContainer.SORTNATURAL))
						.buildYearSort();
