...
public class TexProjectionAnnotation extends ProjectionAnnotation {
	 ...
	 * 
	 * @param node
	 *            The node for creating the annotation
	 */
	 ...
	 *            The node for creating the annotation
	 * @param isCollaped
	 *            Whether this node should initially be collapsed or not
	 */
	...
	/**
	 * Tests whether this annotation corresponds to the same document area as
	 * the argument.
	 * 
	 * @param on
	 ...
	 * 
	 * @param offset
	 *            The offset inside the document that this annotation belongs to
	...
	/**
	 * Checks whether this annotation is deeper than the given annotation by
	 * comparing offsets and lengths of the annotations.
	 * 
	 * @param tpa
	 *            The annotation to compare to
